...
function to_ajax(){
    ...
    $.ajax({url: "/insurance/",type: "GET",dataType: "html"}).done(function(data){
...
function get_aboard () {
    ...
    document.getElementById('aboard_link').click();
    document.getElementById('aboard_link1').click();
   
}

function get_aboard1 () {
    var params = {
        api: "insurance_api",
        action: "get_aboard",
...
function load_aboard() {
   // $("#main_div").load("file:///C:/insur_js_mysql/views/pages/home/aboard.html");
   document.getElementById("main_div").innerHTML='<object type="text/html" data="C:/insur_js_mysql/views/pages/home/aboard.html" ></object>';
    document.getElementById("main_div").innerHTML='<object type="text/html" data="C:/insur_js_mysql/views/pages/home/aboard.html" ></object>';
}
